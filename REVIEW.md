...
Pre-PMF, a single operator, three registered agents on one Linux host plus one legacy instance — all of them running businesses or someone's daily life, which is why an accidental restart is not a cheap mistake here. Iteration speed beats
