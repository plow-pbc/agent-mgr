...
def test_reload_refuses_to_run_outside_agent_mgr(tmp_path):
    ...
    # Carries os.environ's PATH forward: this shells the very script whose
    # reload restarted production, and the guard refuses a PATH that would
    # resolve the operator's docker.
